...
using Motogari.Droid.Activities;
...
namespace Motogari.Droid.Adapters
{
    public class CustomMenuAdapter : RecyclerView.Adapter
    {
        ...
        void OnMenuItemClick(object sender, EventArgs e)
        {
            ...
            //if (pos != 0 && pos != 8)
            //{
            //    if(ActivityInstance is HomeActivity){
            //    ((HomeActivity)ActivityInstance).CloseNavigationDrawer();    
            //    }else{
            //        ((DrawerActivity)ActivityInstance).CloseNavigationDrawer();
            //    }
            ...
            ((DrawerActivity)ActivityInstance).OnMenuItemSelected(pos,null);
        }
